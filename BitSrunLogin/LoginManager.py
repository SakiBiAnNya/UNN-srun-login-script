...
class LoginManager:
	def __init__(self,
		url_login_page = "http://172.31.132.1/srun_portal_pc?ac_id=1&theme=pro",
		url_get_challenge_api = "http://172.31.132.1/cgi-bin/get_challenge",
		url_login_api = "http://172.31.132.1/cgi-bin/srun_portal",
		n = "200",
		vtype = "1",
		acid = "1",
		enc = "srun_bx1"
